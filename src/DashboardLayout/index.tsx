...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-white text-gray-800">
      ...
      `}>
        <div className="h-16 flex items-center justify-center bg-[#F0F4F4] border-b border-gray-200">
          <img src={Scrutz} alt="Scrutz" className="w-8 h-8" />
          <h1 className="text-2xl font-bold text-[#004d40] ml-2">Scrutz</h1>
        </div>
        ...
        <div className="p-4 space-y-4 bg-[#F0F4F4] flex-1 overflow-y-auto">
          ...
          <Link
            ...
            className="flex items-center justify-center bg-[#004d40] text-white py-3 rounded-lg hover:bg-[#00695c] transition"
            onClick={() => setIsSidebarOpen(false)}
          >
          ...
          <nav className="space-y-2">
            <Link
              ...
              className="flex items-center space-x-2 px-3 py-3 rounded-md hover:bg-gray-100"
              onClick={() => setIsSidebarOpen(false)}
            >
            ...
            <button className="flex items-center space-x-2 px-3 py-3 rounded-md hover:bg-gray-100 w-full text-left">
        ...
        <div className="hidden lg:block p-4 text-sm text-gray-500 border-t border-gray-200">
          <div className="p-3 bg-white rounded-md text-center">
            <p className="font-medium mb-1">Need help?</p>
            <p className="text-xs">We're readily available to provide help</p>
            <button className="mt-2 px-3 py-1 text-white bg-[#004d40] rounded-md text-xs">
      ...
      <div className="flex-1 flex flex-col lg:ml-0 min-h-screen">
        ...
        <header className="hidden lg:flex h-16 bg-white border-b border-gray-100 items-center justify-between px-6">
          <input
            ...
            className="border rounded-md px-4 py-2 w-1/2 text-sm focus:outline-none focus:ring-1 focus:ring-[#004d40]"
          />
        ...
        <div className="lg:hidden px-4 pt-20 pb-4 bg-white border-b border-gray-100">
          <input
            type="text"
            placeholder="Search for anything..."
            className="border rounded-md px-4 py-3 w-full text-sm focus:outline-none focus:ring-1 focus:ring-[#004d40]"
          />
        </div>
